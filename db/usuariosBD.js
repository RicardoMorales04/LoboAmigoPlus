...
const { validarPassword, generarPassword } = require("../middlewares/funcionesPassword");
...
async function modificarUsuario(datos) {
    ...
    if (user !== undefined) {
        if (datos.password === "") {
            ...
            // Ensure that datos.password is a string before calling generarPassword
...
if (datos.password === "") {
    ...
    if (Array.isArray(datos.password)) {
        // Handle the array case, for example, by joining its elements
