...
const conexionN= require("../db/conexion");
var { mostrarNegocio, buscarNegocioID, nuevoNegocio, modificarNegocio, borrarNegocio, mostrarNegociosUsuario, incrementarCalificacion,  mostrarNegocioOrdenadoPorCalificacion, validarCamposNoVacios}=require("../db/negocioBD");
var{buscarUsuarioID}=require("../db/usuariosBD");
